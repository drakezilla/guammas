...
abstract class BaseHorarioUbicacionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'horario_corrido'      => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'horario_corrido'      => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
